...
function applyFiltersAndSort() {
  ...
  // Фильтрация товаров, если отмечен чекбокс
  ...
  // Отображаем отсортированные и отфильтрованные товары
  getCatalog(filteredItems);
}

// Изначальная отрисовка товаров
...
// Слушатель на изменение чекбокса для фильтрации
poorItemsRemoveCheckbox.addEventListener("input", () => {
  applyFiltersAndSort();
});
