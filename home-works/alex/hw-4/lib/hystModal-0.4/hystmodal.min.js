            ...
            return (
               ...
               (n = [
                  ...
                  },
                  {
                     ...
                     value: function (t) {
                        if (
                           ...
                           if (this.isOpened)
                              return (
                                 (this._reopenTrigger = !0), void this.close()
                              );
                           (this.openedWindow = this._nextWindows),
                              (this._modalBlock =
                                 this.openedWindow.querySelector(
                                    ".hystmodal__window"
                                 )),
                              this.config.beforeOpen(this),
                              this._bodyScrollControl(),
                              e._shadow.classList.add(
                                 "hystmodal__shadow--show"
                              ),
                              this.openedWindow.classList.add(
                                 "hystmodal--active"
                              ),
                              this.openedWindow.setAttribute(
                                 "aria-hidden",
                                 "false"
                              ),
                           ...
                           console.log(
                              "Warinig: hustModal selector is not found"
                           );
                     },
                  },
                  {
                  ...
                  },
                  {
                     key: "focusContol",
                     value: function () {
                        var e = this.openedWindow.querySelectorAll(
                           this._focusElements
                        );
                  ...
                  },
                  {
                     key: "focusCatcher",
                     value: function (e) {
                        var t = this.openedWindow.querySelectorAll(
                              this._focusElements
                           ),
                           n = Array.prototype.slice.call(t);
                        if (
                           this.openedWindow.contains(document.activeElement)
                        ) {
                           ...
                           (t.style.top = -this._scrollPosition + "px"),
                              n &&
                                 ...
                                 e.map(function (e) {
                                    e.style.marginRight =
                                       parseInt(
                                          getComputedStyle(e).marginRight
                                       ) +
                                       n +
                                       "px";
                                 })),
