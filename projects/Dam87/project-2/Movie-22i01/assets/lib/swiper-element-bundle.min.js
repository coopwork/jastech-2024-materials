            ...
            ue({
                ...
                setTranslate: () => {
                    ...
                    if (
                        ...
                        if (u)
                            h.style.transform = `translate3d(0px, ${r / 2 + c.shadowOffset
                                }px, ${-r / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${c.shadowScale
                                })`;
                        else {
                            const e = Math.abs(f) - 90 * Math.floor(Math.abs(f) / 90),
                                ...
                                i = c.shadowScale / t,
                                a = c.shadowOffset;
                            h.style.transform = `scale3d(${s}, 1, ${i}) translate3d(0px, ${n / 2 + a
